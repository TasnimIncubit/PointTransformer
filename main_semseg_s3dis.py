...
# test_save_path = '/home/tasnim/pipe_center_prediction/dgcnn.pytorch/all_center_mean_std_min_max_predictions' # 1000 epoch, all data
# test_save_path = '/home/tasnim/pipe_center_prediction/dgcnn.pytorch/all_center_mean_std_predictions' # 1000 epoch, all data
# test_save_path = '/home/tasnim/pipe_center_prediction/dgcnn.pytorch/dgcnn_test_pipe_predictions'
# test_save_path = '/home/tasnim/pipe_center_prediction/dgcnn.pytorch/one_train_test_dgcnn_test_pipe_predictions'
test_save_path = '/home/tasnim/pipe_center_prediction/dgcnn.pytorch/all_radius_train_test_dgcnn_test_pipe_predictions'
...
# loss is L2 loss
    ...
    for epoch in range(args.epochs):
        # loss_meter = AverageMeter("D_loss", ":.4e")
        ####################
        # Train
        ####################
        train_loss = 0.0
        ...
        #                                                                                           avg_per_class_acc,
        #                                                                                           np.mean(train_ious))
        # io.cprint(outstr) # save in a file later
        ...
        torch.save(model.state_dict(), 'outputs/%s/models/model_%s.t7' % (args.exp_name, str(epoch)))
    ...
    plt.savefig('/home/tasnim/pipe_center_prediction/dgcnn.pytorch/loss_plt/one_radius_mean_std_min_max_loss_plot.png')
...
def test(args, io):
    ...
    for data, seg in test_loader:
        ...
        # # save predicted points
        # #save numpy points
        # numpy_filename = 'dgcnn_numpy_pipe_and_axis_' + format(int(count), '05d') + '.npy'
        # np.save(os.path.join(test_save_path, numpy_filename), np_all_points) # sget rotated values
        # print('saving pipe number as np array', int(count))
        # count += 1
        ##########################
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_area', type=str, default=None, metavar='N',
                        help = 'choose the epoch you want to infer')
    # parser.add_argument('--test_area', type=str, default=None, metavar='N',
